...
export function Motto() {
    ...
    return (
        <div className="flex flex-col mb-20 sm:mb-[56.5px] lg:mb-0 mt-auto mx-auto lg:mt-[50vh] transform lg:-translate-y-1/2 lg:ml-[50vw] lg:mr-0 gap-6 sm:gap-8 w-max h-max">
